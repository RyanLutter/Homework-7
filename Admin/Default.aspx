...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <asp:GridView ID="gv_data" runat="server" AutoGenerateColumns="False" DataKeyNames="playerID" DataSourceID="sql_data" HorizontalAlign="Center" CssClass="border">
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="Details of Player" DataNavigateUrlFormatString="~/Admin/Adminplayerdetails.aspx?playerID={0}"
                     Text="Select" DataNavigateUrlFields="playerID" />
            </Columns>
