...
<asp:SqlDataSource ID="sql_playerdata" runat="server" ConnectionString="<%$ ConnectionStrings:rlutter_HW7 %>" SelectCommand="SELECT * FROM [rlutter_HW7]"></asp:SqlDataSource>
        ...
        <% Else%>Search for another player by name:
            ...
            <asp:GridView ID="gv_search" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="playerID" DataSourceID="sql_playerdata" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center">
                <Columns>
